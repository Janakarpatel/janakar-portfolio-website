...
export default function Footer({ timestamp }: FooterProps) {
    return (
        <div className="w-full z-10 relative md:fixed md:bottom-0 md:left-0">
            <div className="p-6 flex justify-between items-end max-[768px]:p-6 max-[768px]:flex-col-reverse max-[768px]:gap-3 max-[768px]:items-start max-[480px]:p-6 max-[480px]:flex-col-reverse max-[480px]:gap-3 max-[480px]:items-start">
